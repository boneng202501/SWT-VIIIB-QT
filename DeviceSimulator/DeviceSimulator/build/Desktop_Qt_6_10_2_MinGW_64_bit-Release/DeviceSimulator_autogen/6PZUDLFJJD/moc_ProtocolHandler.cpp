...
#include "../../../../udp_dev/ProtocolHandler.h"
...
void ProtocolHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->voltageRegResult((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProtocolHandler::*)(bool )>(_a, &ProtocolHandler::ioInitFinished, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ProtocolHandler::*)(int , float )>(_a, &ProtocolHandler::voltageRegResult, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ProtocolHandler::*)(const QString & )>(_a, &ProtocolHandler::logMessage, 2))
            return;
    }
}
...
// SIGNAL 1
void ProtocolHandler::voltageRegResult(int _t1, float _t2)
{
